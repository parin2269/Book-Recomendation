    ...
    render(){
        return(
            <View style={styles.container}>
                ...
                <TouchableOpactiy style={styles.genre}onPress={()=>this.props.navigation.navigate("Fantasy")}>
                    <Text style={styles.buttontext}>Fantasy</Text>
                </TouchableOpactiy>
                <TouchableOpactiy style={styles.genre}onPress={()=>this.props.navigation.navigate("Thriller")}>
